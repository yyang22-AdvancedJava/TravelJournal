...
<c:set var="activePage" value="viewByUser" scope="request" />
...
<main class="container mt-5 pb-5">
  <div class="row justify-content-center">
    <div class="col-md-10 col-lg-8">
      ...
      <h2 class="text-center fw-bold mb-5">View by User</h2>

      <%-- 검색 폼: action을 viewByUser 서블릿으로 연결 --%>
      <form action="viewByUser" method="get" class="row g-3 justify-content-center mb-5 align-items-center">
        <div class="col-auto">
        ...
        <c:forEach var="journal" items="${journals}">
          ...
          <div class="journal-card ${weatherClass} shadow-sm mb-4">
            ...
            <div class="journal-body">
              <p class="fs-5 text-dark mb-0">${journal.content}</p>
            </div>
          </div>
        </c:forEach>
      </c:if>
      ...
      <%-- 결과 없을 때 --%>
      <c:if test="${empty journals && param.userName != null}">
        <p class="text-center text-muted mt-5">No journals found for user "${param.userName}".</p>
      </c:if>
