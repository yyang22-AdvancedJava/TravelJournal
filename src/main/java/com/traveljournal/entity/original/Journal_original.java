package com.traveljournal.entity.original;
...
public class Journal_original {
     ...
     * @param weather
     */
    public Journal_original(User user, String title, String content, LocalDate created_at, LocalDate updated_at, String location, String weather) {
